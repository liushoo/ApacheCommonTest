...
/**
 * Created by liush on 17-7-30.
 */
public class AbstractQueryHiveRunner {
         ...
         */
        public AbstractQueryHiveRunner() {
            ds = null;
        }
         ...
         *            not to use it again.
         */
        public AbstractQueryHiveRunner(boolean pmdKnownBroken) {
         ...
         */
        public AbstractQueryHiveRunner(DataSource ds) {
            this.ds = ds;
        }
         ...
         *            not to use it again.
         */
        public AbstractQueryHiveRunner(DataSource ds, boolean pmdKnownBroken) {
            this.pmdKnownBroken = pmdKnownBroken;
            this.ds = ds;
        }
        ...
        public void fillStatement(PreparedStatement stmt, Object... params)
            ...
            System.out.println("==="+stmt+"==="+pmdKnownBroken);
            if (!pmdKnownBroken) {
                System.out.println("==pmdKnownBroken==="+pmdKnownBroken+"===");
                pmd = stmt.getParameterMetaData();
                System.out.println("==pmdKnownBroken==="+pmdKnownBroken+"==222==="+pmd);
               // System.out.println("getParameterMetaData:"+pmd);
            ...
            // nothing to do here
            System.out.println("==params==="+params==null+"==="+params.length);
            if (params == null) {
                return;
            }
