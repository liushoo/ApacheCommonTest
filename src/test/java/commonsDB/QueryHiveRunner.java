 ...
 */
public class QueryHiveRunner extends AbstractQueryHiveRunner {
    /**
     * Constructor for QueryRunner.
     */
    public QueryHiveRunner() {
        super();
    }
     ...
     */
    public QueryHiveRunner(boolean pmdKnownBroken) {
     ...
     */
    public QueryHiveRunner(DataSource ds) {
        super(ds);
    }
     ...
     * and if it breaks, we'll remember not to use it again.
     */
    public QueryHiveRunner(DataSource ds, boolean pmdKnownBroken) {
    ...
    private <T> T query(Connection conn, boolean closeConn, String sql, ResultSetHandler<T> rsh, Object... params)
        ...
        try {
            ...
            stmt = this.prepareStatement(conn, sql);
            System.out.println("====stmt======="+stmt+"==="+params);
            this.fillStatement(stmt, params);
            System.out.println("====fillStatement======="+stmt);
